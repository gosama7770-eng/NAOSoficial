...
(function () {
  ...
  function initBooking() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      // En móvil se abre la app de WhatsApp directamente en la misma pestaña (lo más fiable);
      // en ordenador, en una pestaña nueva. Si el navegador bloquea la ventana, se usa la misma.
